...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  coresignal: {
    commitmentTier: "medium",
    commitmentLabel: "TBD post-restructure",
    pricingTldr: "Jul 27: pricing plans restructured 10→7, unified 'API Credits' unit, job postings 10x cheaper/request. Prior flat-file quote context predates this restructure — re-confirm current numbers with Paulius.",
    pricingDetail: "Jul 27 marketing announcement: plan count cut from 10 to 7; all API calls now unified under a single 'API Credits' unit (replacing separate Search/Collect credits); job posting records cost 10x less per API request. Bake-off vs MixRank for on-prem LinkedIn post/engagement dataset still in progress — commercial terms pending outcome.",
    capability: "finds-enrich-dataset",
    commercialNextStep: "Reschedule Jul 29 meeting with Paulius Borkys to a morning slot (he can't do SF-afternoon). Once technical bake-off vs MixRank concludes, get current pricing under the new 7-plan structure and kick off legal/MSA review.",
    commercialOwner: "haley",
    annualBudgetUsd: null,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
    coverageNote: "LinkedIn people + company post data — ~800M historical posts, 10M+ new/day, 2-3 day freshness lag",
    financeNote: "Pricing under active restructure as of Jul 27 (10→7 plans). Hold budget number until new plan pricing is confirmed with Paulius.",
    legalStatus: "not-started",
    resellAgreementStatus: null,
    legalNotes: "No MSA/contract work started yet in this sweep's sources. Technical validation (scrape prioritization, commenter-cap, 6.8M-post gap root cause) ongoing as of Jul 27; MSA review to follow once bake-off concludes.",
  },
  ...
  fullenrich: {
    ...
    pricingTldr: "Two tiers from Ben Douablin (Jul 27): Option 1 = $100K real-time + $200K flat-file add-on ($0.018/credit). Option 2 = $250K real-time + $150K flat-file ($0.016/credit).",
    pricingDetail: "Credits: 1 = verified work email, 10 = mobile phone, 3 = personal email. FullEnrich is pushing to keep email/phone delivery API-only (waterfall-based) rather than flat-file, citing freshness/coverage advantages of the real-time API over a static dataset.",
    capability: "enrich-only",
    commercialNextStep: "Evaluate flat-file vs. real-time-only quality tradeoff Ben raised; decide which tier (if either) fits Unify's waterfall-supplement use case before progressing commercially.",
    commercialOwner: "haley",
    annualBudgetUsd: null,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
    ...
    legalStatus: "not-started",
    resellAgreementStatus: null,
    legalNotes: "Jul 27: Ben Douablin (FullEnrich) sent two commercial tiers in #partnership-unify-fullenrich in response to Austin's question. No legal docs exchanged yet.",
  },
