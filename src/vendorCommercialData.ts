...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  coresignal: {
    commitmentTier: "medium",
    commitmentLabel: "$3,500/mo flat (agreed Aug 5, 5% renewal cap)",
    pricingTldr: "Aug 5: Coresignal agreed to Austin's ask — $3,500/mo flat rate w/ 5% cap on annual renewal increases, for the People+Company Posts bundle w/ daily delivery. Pricing resolved; now in final MSA redlining.",
    ...
    capability: "finds-enrich-dataset",
    commercialNextStep: "Pricing is resolved ($3,500/mo flat, 5% renewal cap). Aug 25: Haley reinstated the Section 13.3 supercap ask (greater of $250K or 3x trailing-12mo fees) in the latest redline pass; Coresignal's team reviewing internally, aiming to finalize 'ASAP, ideally EOM.' Aug 26: Paulius sent semi-formal team comments ahead of drafting final redlines, expected Aug 27 — review and respond before then. Separately, still need Paulius's corrected file + 28 zero-coverage profile URLs investigated before re-testing coverage, and outcome of Coresignal's internal Friday Data+Scraping strategy session on Posts limitations.",
    commercialOwner: "haley",
