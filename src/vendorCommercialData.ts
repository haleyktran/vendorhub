...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  fullenrich: {
    ...
    capability: "enrich-only",
    commercialNextStep: "Aug 6: Byron sent DPA response — deal is '95% there' with 2 remaining items: (1) 2x-contract-value cap on the indemnity liability (vs. unlimited), (2) FullEnrich handling data subject requests directly with a global suppression list, notifying Unify after the fact. Aug 7: Haley confirmed with Varad (data team) that the DSR ask is acceptable — matches how Unify already operates (DSRs received directly are never passed to vendors). Still need a decision on the 2x liability cap ask. All three docs now in final rounds: MSA (Unify redlined Jul 30, FullEnrich reviewing), DPA (FullEnrich responded Aug 6, Unify reviewing), Reseller Agreement (Unify redlined + sent Aug 6, FullEnrich reviewing). Also still need to resolve the ~47s async latency blocker before committing to either pricing tier. Give Ross a heads-up once contract work formally kicks off — integration work is slotted in after the enrichment-provider-controls project (mid-August start). Aug 17 (#pod-enrichment sprint goals, Ross Alexander): eng has now started 'fullenrich integration: scope & cut tickets' this sprint — integration scoping is underway in parallel with the outstanding legal reply expected by Monday EOD. Aug 20: DPA-precedence and damages-supercap legal call held (vendor inferred as FullEnrich from call context — French legal team, founder on the line, Section 13/0818-redline continuity — not confirmed by name on the transcript). Their side to re-check DPA-over-MSA precedence with their lawyer (Axel, on PTO) and reply Fri Aug 21 or Mon Aug 24. Damages carve-out landing around a 5x supercap (they proposed 2x citing normally-uncapped consequential damages; Haley held at 5x, not uncapped) — expect this to close early next week pending their lawyer's confirmation. Aug 19 (Slack DM, Byron): sent the specific liability terms Ben/Austin agreed to — 1x cap on ordinary contractual liability; supercap = greater of 3x fees or $250K (applies only to claims about lawfulness/sourcing of FullEnrich's data, not a general cap); uncapped for fraud/willful misconduct/gross negligence/confidentiality breach; no stacking; 1 event = 1 cap across MSA/DPA/reseller docs. Aug 20 (Slack DM, Haley→Austin): Haley's position — concede to the $250K/3x supercap and drop stacking; push Ben via Austin on two remaining asks: extend the supercap to cover the DPA itself (not just the sourcing-claim carveout), and raise the consequential-damages-waiver carveout above FullEnrich's proposed 2x to the 5x figure discussed on the same-day Granola legal call. Aug 21 (#pod-enrichment/#epd-weekly-updates): eng has FullEnrich spec'd and ticketed, targeting GA by end of this week or early next (PR #15786, 'add fullenrich schema'). Contract needs FullEnrich's reply by Monday Aug 24. Aug 26 (#pod-enrichment, Ross Alexander): implementation may slip to next week pending contract close. Aug 26 (Slack DM, Byron): FullEnrich's legal accepted DPA>Order Form>MSA precedence and proposed indemnification carve-out language keeping it within the agreed liability cap — Byron considers the deal 'done-done after this.' Aug 27 (#pod-enrichment, Austin): confirmed Haley is on point and signing is imminent — enrichment pod is currently blocked on FullEnrich's signature.",
    commercialOwner: "haley",
    annualBudgetUsd: null,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
