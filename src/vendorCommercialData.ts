...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  demandbase: {
    commitmentTier: "high",
    commitmentLabel: "$750K/yr current",
    pricingTldr: "Current contract $750K/yr, being reassessed. Sep 21 meeting: API-call-based pricing model under consideration for renewal — echoes the 6sense OEM-formalization pattern.",
    pricingDetail: "Demandbase's Company Identification API is already live in Unify's production website-visitor waterfall (one of 3 providers alongside 6sense and Clearbit — see 6sense entry). Sep 21 meeting held (Austin, Haley + Alexandra Bonavota/D. Fiori from Demandbase): confirmed current annual contract is $750K, now being reassessed with an API-call usage model on the table for renewal. Also touched on contact/email coverage as Unify's current data-gap focus. Haley to send a clean active-customer count; Demandbase to send API usage/pricing scenarios ahead of the Oct 5 follow-up.",
    capability: "enrich-only",
    commercialNextStep: "Send Demandbase a clean active-customer count. Review their API usage/pricing scenarios once received. Attend Oct 5 follow-up call to negotiate the renewal structure.",
    commercialOwner: "haley",
    annualBudgetUsd: 750000,
    budgetStatus: "tentative",
    estimatedAnnualVolume: null,
    coverageNote: "Company identification / website-visitor deanonymization API — one of 3 providers (6sense, Demandbase, Clearbit) in production waterfall",
    financeNote: "Existing $750K/yr contract under renewal renegotiation toward an API-call-based model — same category exposure pattern as 6sense, but here the current contract is signed/known (not an unbilled-usage gap).",
    legalStatus: "contract-review",
