...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  forager: {
    ...
    financeNote: "Contract signed; standard min 50K credits/yr, quarterly invoicing. Jun–Jul 2026 invoicing friction (accounting delay on first quarterly payment) since resolved. Re-checked this sweep: Gmail thread shows Diana at Forager followed up repeatedly (Jul 8, 14, 21) that the invoice still hadn't been paid despite Forager's credits already being added; Jul 22 Haley said the COO had approved payments and asked Diana to confirm receipt — no reply found after that, so worth a quick confirm with accounting that it actually cleared. Aug 12: Escalated — Peter Friis (Forager) emailed Will + Haley directly about a specific overdue invoice, $8,071.87 sent Jun 18, now past extended terms. Alex Lucey (COO) escalated same day, cc'ing accounting/ap, asking for it to be resolved immediately. Still unresolved as of Aug 12 EOD — this is the same unpaid-invoice thread flagged Aug 10, now escalated to COO level; needs a direct confirm from accounting that payment has gone out.",
    legalStatus: "contract-signed",
    resellAgreementStatus: "ready-to-sign",
