...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  coresignal: {
    ...
    capability: "finds-enrich-dataset",
    commercialNextStep: "Pricing is resolved ($3,500/mo flat, 5% renewal cap). Aug 5: Haley sent the redlined MSA to Coresignal and has just received the last round of edits back (#external-unify-coresignal, 1:55pm) — review those edits next and confirm the 3 outstanding legal items are reflected: (1) reseller/end-customer redistribution language matches intended delivery, (2) Real-Time API usage / data retention clause resolved, (3) DPA attached and reviewed. Separately, still need Paulius's corrected file + 28 zero-coverage profile URLs investigated before re-testing coverage, and outcome of Coresignal's internal Friday Data+Scraping strategy session on Posts limitations.",
    commercialOwner: "haley",
