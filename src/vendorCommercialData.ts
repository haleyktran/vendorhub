...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  heyreach: {
    ...
    capability: "platform",
    commercialNextStep: "Get HeyReach trial access live (targeting Jul 31), send API rate limit requirements, review both pricing proposals (overdue since Jul 28), and request MSA + legal docs via Slack to start compliance review — none of this is done yet.",
    commercialOwner: "haley",
    annualBudgetUsd: null,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
    ...
    legalStatus: "not-started",
    resellAgreementStatus: "need-reseller-agreement",
    legalNotes: "Jul 27: pricing call covered two commercial structures, no agreement drafted. Jul 30: Haley still needs to request MSA + legal docs via Slack — not yet requested. No legal work started.",
  },
