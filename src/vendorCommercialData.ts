...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  retentiondotcom: {
    ...
    pricingTldr: "$0.05–$0.08/resolution + $1.00/domain fee. Usage-based, no prepaid. Reopened Sep 15 as an active OEM negotiation (RB2B), no longer purely deprioritized.",
    pricingDetail: "OEM: $0.08/resolution + $1.00/domain. Volume tiers: $0.06 at 50K, $0.05 at 100K+. Usage-based, no prepaid credits. Website visitor de-anonymization only (RB2B product). Sep 15: Haley asked Diana Ross for a reference contract with commercial/legal terms to review — none received yet this sweep.",
    capability: "enrich-only",
    commercialNextStep: "Sep 15 (Gmail): Haley re-opened the RB2B OEM partnership conversation with Diana Ross — asked to catch up this week and requested a reference contract with commercial/legal terms ASAP. Awaiting Diana's reply and the reference contract; once received, route to legal and kick off commercial negotiations (per Haley's plan shared internally the same day).",
    commercialOwner: "haley",
    annualBudgetUsd: null,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
    ...
    financeNote: "No longer purely deprioritized — Sep 15 re-engagement puts RB2B OEM back on the table (see vendorHubData rb2b entry for the parallel product-eval status). No budget figure set yet pending the reference contract.",
    legalStatus: "not-started",
    resellAgreementStatus: "need-reseller-agreement",
    legalNotes: "Aug 11 meeting ('B2B contact data and validation strategy with founder') surfaced a separate personal-email/validation offering not covered by this pricing: Retention.com's differentiator is 9 years of consumer-to-business personal-email identity linkage; Unify's stated interest order was (1) incremental work email/mobile coverage, (2) personal email — revisit in a few months, (3) web deanonymization. Aug 14 (Gmail, Diana Ross): flagged RB2B OEM as worth exploring 'a few months from now,' offered a near-term test of Retention.com's Contact Data File instead (uses Trestle for phone validation). Sep 15 (Gmail, Haley → Diana): re-opened the OEM conversation specifically on web visitor reveals, requested a reference contract w/ commercial+legal terms to review ASAP — no legal document received yet, so legalStatus remains not-started pending that contract.",
  },
