...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  unipile: {
    commitmentTier: null,
    commitmentLabel: "TBD",
    pricingTldr: "No pricing or commercial terms surfaced yet — evaluation has been technical/testing-plan stage. Competing head-to-head with HeyReach for Unify's native LinkedIn outreach automation integration.",
    pricingDetail: "Trial API key extended 7 days by Julien (Jul 30) after the original key expired. Kevin Liang volunteered Jul 31 to run the Unipile+HeyReach POC solo and referenced Unipile's provider-limits/restrictions docs for send-schedule/jitter design. No commercial proposal has been sent by Unipile in this sweep's sources.",
    capability: "platform",
    commercialNextStep: "Aug 4 3:38pm (#product-linkedin-automation): Haley now has Unipile's legal agreement in hand (alongside HeyReach's) but hasn't sent either out for review yet — she asked Kevin Liang/James Grinage/Joe Lipshutz when the team wants to converge on a vendor choice between HeyReach and Unipile, and offered to scope the legal review this week or next once that lands. Next: get a decision on timing, then route whichever agreement(s) are needed to Crosby.",
    commercialOwner: "haley",
    annualBudgetUsd: null,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
    coverageNote: "LinkedIn outreach automation platform — evaluated head-to-head vs. HeyReach for Unify's native LinkedIn integration. Currently in technical/testing-plan stage; no pricing model surfaced yet.",
    ...
    legalStatus: "not-started",
    resellAgreementStatus: null,
    legalNotes: "Aug 4: Haley has Unipile's legal agreement in hand but has not sent it out for review — legal work has not formally started. Blocked on internal HeyReach-vs-Unipile convergence (owned by James Grinage/Kevin Liang/Joe Lipshutz) before scoping which agreement(s) go to Crosby.",
  },
