...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  fullenrich: {
    ...
    capability: "enrich-only",
    commercialNextStep: "Jul 29: Austin recommended moving forward with a FullEnrich partnership in #pod-enrichment — Haley + Ross owe a reply/decision, not yet sent as of this sweep. Still need to resolve the ~47s async latency blocker before committing to either tier.",
    commercialOwner: "haley",
    annualBudgetUsd: null,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
    ...
    legalStatus: "not-started",
    resellAgreementStatus: null,
    legalNotes: "Jul 27: Ben Douablin (FullEnrich) sent two commercial tiers in #partnership-unify-fullenrich in response to Austin's question. Jul 29: Austin recommended partnership in #pod-enrichment; Haley + Ross owe a reply. No legal docs exchanged yet.",
  },
  ...
  twilio: {
    ...
    capability: "platform",
    commercialNextStep: "Reply to Twilio thread requesting the order form (with upfront commit options), MSA, and DPA — no formal contract review started yet, only email exchange as of Jul 30. Project dial volume for the next year to set a conservative commit number before signing. Loop in Crosby for legal review once docs arrive.",
    commercialOwner: "haley",
    annualBudgetUsd: 150000,
    budgetStatus: "exploring",
    estimatedAnnualVolume: null,
    ...
    financeNote: "$150K/yr minimum commit under negotiation; James Grinage wants both the commit level and per-minute/per-number rates pushed lower than Twilio's proposal. Haley looped in by James (Jul 30) to help drive the negotiation alongside Ami.",
    legalStatus: "not-started",
    resellAgreementStatus: null,
    legalNotes: "Jul 30 (Granola, Twilio Contract Negotiation): no formal contract yet, only email exchange — need to request order form, MSA, and DPA from Twilio. DPA required since Twilio processes personal data (phone numbers); unclear if one was ever previously signed. Jul 30 (Slack DM, James/Haley): James asked Haley to help negotiate and drive the process; Haley agreed, already pinged Ami, will research comparable rates before the call.",
  },
