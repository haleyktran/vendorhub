...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  coresignal: {
    ...
    capability: "finds-enrich-dataset",
    commercialNextStep: "Contract fully negotiated: pricing ($3,500/mo flat, 5% renewal cap) and liability supercap ($200K floor / 3x trailing-12mo fees, landed Aug 27 after Haley pushed back on Coresignal's initial $150K floor) both resolved. Coresignal sent the final contract + order form via DocuSign Aug 28 (merged doc covering data products, company details, term, commercials) along with a 3-month prepayment proforma invoice to accounting@unifygtm.com. Aug 31: accounting confirmed receipt of the invoice. Sep 2: Varad began the technical data-delivery handshake with Paulius (S3 delivery into Unify's ingestion bucket — requested Coresignal's AWS account ID/IAM ARN + STS External ID), suggesting integration is proceeding in parallel with signature/payment. Next: confirm DocuSign is signed and payment processed (still unconfirmed as of this sweep — flag to ADL/accounting, who separately noted Sep 3 the signed contract PDF isn't yet in Ramp's contract system for invoice approval). Separately, still need Paulius's corrected file + 28 zero-coverage profile URLs investigated before re-testing coverage, and outcome of Coresignal's internal Friday Data+Scraping strategy session on Posts limitations.",
    commercialOwner: "haley",
