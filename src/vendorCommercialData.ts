...
export const vendorCommercialData: Record<string, VendorCommercial> = {
  ...
  coresignal: {
    commitmentTier: "medium",
    commitmentLabel: "$3K-4K/mo (revised Aug 4, was $8-9K/mo → $15K/mo)",
    pricingTldr: "Aug 4: Paulius revised the offer sharply — $3,000/mo (mo 1-6) → $4,000/mo (mo 7-12) for the People+Company Posts bundle w/ daily delivery, down from the $8-9K/mo (LinkedIn-only) → $15K/mo (multi-source) quoted Jul 30. Haley countered same day with a $3.25K/mo flat rate + 5% annual renewal cap; Austin separately wants $3,500/mo flat. Awaiting Paulius's reply.",
    pricingDetail: "Jul 30 call (Paulius + Kevin Kim + Austin Hughes): $8-9K/mo for LinkedIn-only delivery, scaling to $15K/mo for multi-source. Jul 27 marketing announcement: plan count cut from 10 to 7; all API calls now unified under a single 'API Credits' unit; job posting records cost 10x less per API request. Coverage gap flagged Jul 30: ~10% of 300 sampled active posters had zero posts in the flat file (unexplained); ~3-day median post discovery lag; private profiles not scraped. Aug 3: Haley opened the booked call with the $2,000/mo counter-ask per James's negotiating tactic. Aug 4 8:26am: Paulius came back with a detailed Posts-limitations breakdown (discovery is probabilistic — median ~3 days, 25% within 1 day, 90% within 9 days; frequent posters under-represented; no full liker/reactor identity; Company Posts live since May 2026) and a revised offer of $3,000/mo (months 1-6) stepping to $4,000/mo (months 7-12) for People+Company Posts bundled with daily delivery — a steep drop that shows the counter-ask worked. Aug 4: Austin wants a flat $3,500/mo instead of the tiered structure, with a 5% cap on annual renewal increases, to avoid a post-year-1 jump. Haley's actual counter to Paulius went slightly lower — $3.25K/mo flat across 12 months with the same 5% renewal cap — plus a request for a company-posts-specific refresh-cadence breakdown. Bake-off vs MixRank for on-prem LinkedIn post/engagement dataset still in progress.",
    capability: "finds-enrich-dataset",
    commercialNextStep: "MSA due back to Crosby Fri Jul 31 — confirm 3 outstanding action items first: (1) reseller/end-customer redistribution language matches intended delivery, (2) confirm whether Unify will use Coresignal's Real-Time API (data retention clause), (3) DPA attached and reviewed. Separately, get Paulius's corrected file + 28 zero-coverage profile URLs investigated before re-testing coverage. Aug 4: awaiting Paulius's response to Haley's $3.25K/mo flat-rate + 5% renewal-cap counter and her ask for a company-posts refresh-cadence breakdown. Coresignal's internal Data+Scraping teams are holding a Friday strategy session on the Posts limitations Haley raised — get the outcome once shared. Once pricing lands, resume the outstanding MSA action items above before finalizing.",
    commercialOwner: "haley",
